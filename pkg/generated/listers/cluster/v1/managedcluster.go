...
// List lists all ManagedClusters in the indexer for a given namespace.
func (s managedClusterNamespaceLister) List(selector labels.Selector) (ret []*v1.ManagedCluster, err error) {
...
// Get retrieves the ManagedCluster from the indexer for a given namespace and name.
func (s managedClusterNamespaceLister) Get(name string) (*v1.ManagedCluster, error) {
