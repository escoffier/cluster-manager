...
import (
	...
	clusterv1 "github.com/escoffier/cluster-manager/pkg/api/cluster/v1"
...
var managedclustersResource = schema.GroupVersionResource{Group: "cluster.security.io", Version: "v1", Resource: "managedclusters"}

var managedclustersKind = schema.GroupVersionKind{Group: "cluster.security.io", Version: "v1", Kind: "ManagedCluster"}
...
func (c *FakeManagedClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *clusterv1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(managedclustersResource, c.ns, name), &clusterv1.ManagedCluster{})
...
func (c *FakeManagedClusters) List(ctx context.Context, opts v1.ListOptions) (result *clusterv1.ManagedClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(managedclustersResource, managedclustersKind, c.ns, opts), &clusterv1.ManagedClusterList{})
...
func (c *FakeManagedClusters) Create(ctx context.Context, managedCluster *clusterv1.ManagedCluster, opts v1.CreateOptions) (result *clusterv1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(managedclustersResource, c.ns, managedCluster), &clusterv1.ManagedCluster{})
...
func (c *FakeManagedClusters) Update(ctx context.Context, managedCluster *clusterv1.ManagedCluster, opts v1.UpdateOptions) (result *clusterv1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(managedclustersResource, c.ns, managedCluster), &clusterv1.ManagedCluster{})
...
func (c *FakeManagedClusters) UpdateStatus(ctx context.Context, managedCluster *clusterv1.ManagedCluster, opts v1.UpdateOptions) (*clusterv1.ManagedCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(managedclustersResource, "status", c.ns, managedCluster), &clusterv1.ManagedCluster{})
...
func (c *FakeManagedClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(managedclustersResource, c.ns, name), &clusterv1.ManagedCluster{})
...
func (c *FakeManagedClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *clusterv1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(managedclustersResource, c.ns, name, pt, data, subresources...), &clusterv1.ManagedCluster{})
