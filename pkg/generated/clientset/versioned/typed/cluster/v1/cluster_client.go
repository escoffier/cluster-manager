...
import (
	v1 "github.com/escoffier/cluster-manager/pkg/api/cluster/v1"
	"github.com/escoffier/cluster-manager/pkg/generated/clientset/versioned/scheme"
...
// ClusterV1Client is used to interact with features provided by the cluster.security.io group.
type ClusterV1Client struct {
	restClient rest.Interface
}

func (c *ClusterV1Client) ManagedClusters(namespace string) ManagedClusterInterface {
