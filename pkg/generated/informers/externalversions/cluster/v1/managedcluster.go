...
import (
	...
	versioned "github.com/escoffier/cluster-manager/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/escoffier/cluster-manager/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/escoffier/cluster-manager/pkg/generated/listers/cluster/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1().ManagedClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1().ManagedClusters(namespace).Watch(context.TODO(), options)
			},
		},
